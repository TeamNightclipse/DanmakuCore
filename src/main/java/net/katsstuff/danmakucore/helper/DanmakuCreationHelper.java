...
public class DanmakuCreationHelper {
	...
	public static Set<EntityDanmaku> createWideShot(DanmakuBuilder danmaku, int amount, float wideAngle, float baseAngle, double distance) {
	...
	public static Set<EntityDanmaku> createCircleShot(DanmakuBuilder danmaku, int amount, float baseAngle, double distance) {
		ShapeCircle shape = new ShapeCircle(danmaku, amount, baseAngle, distance);
		return shape.drawForTick(danmaku.pos, danmaku.angle, 0).getSecond();
	}

	public static Set<EntityDanmaku> createRingShot(DanmakuBuilder danmaku, int amount, float size, float baseAngle, double distance) {
		ShapeRing shape = new ShapeRing(danmaku, amount, size, baseAngle, distance);
		return shape.drawForTick(danmaku.pos, danmaku.angle, 0).getSecond();
	}

	public static Set<EntityDanmaku> createRandomRingShot(DanmakuBuilder danmaku, int amount, float size, double distance) {
