...
import net.katsstuff.teamnightclipse.danmakucore.danmaku.DanmakuState.{Add, NOOP, PlayerOperation, Remove}
import net.katsstuff.teamnightclipse.danmakucore.data.{MovementData, OrientedBoundingBox, RotationData, ShotData}
...
import net.katsstuff.teamnightclipse.danmakucore.network.{DanCorePacketHandler, DanmakuForceUpdatePacket}
...
case class DanmakuEntityData(
  ...
  lazy val boundingBoxes: Seq[OrientedBoundingBox] = rawBoundingBoxes.map(_.toWorldSpace(pos, orientation))
