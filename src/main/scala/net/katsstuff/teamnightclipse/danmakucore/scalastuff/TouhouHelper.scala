...
import net.katsstuff.teamnightclipse.danmakucore.capability.dancoredata.{CapabilityDanCoreDataJ, IDanmakuCoreData}
...
import net.katsstuff.teamnightclipse.danmakucore.helper.{RemoveMode, TTouhouHelper}
